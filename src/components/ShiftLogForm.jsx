    ...
    return (
        <div>
            ...
            <div className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg">
                <h1 className="text-3xl font-bold mb-6 text-gray-800">Submit Shift Log</h1>
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="bg-gray-50 p-4 rounded-md">
                        <h2 className="text-xl font-semibold mb-4 text-gray-800">Production Data</h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label htmlFor="totalTonnageMined" className="block text-sm font-medium text-gray-700">Total Tonnage Mined</label>
                                <input
                                    type="number"
                            ...
                            <div>
                                <label htmlFor="activeMachines" className="block text-sm font-medium text-gray-700">Active Machines</label>
                                <input
                                    type="text"
                                    id="activeMachines"
                            ...
                            <div>
                                <label htmlFor="machineDowntime" className="block text-sm font-medium text-gray-700">Machine Downtime</label>
                                <input
                                    type="text"
                                    id="machineDowntime"
                    ...
                    <div className="bg-gray-50 p-4 rounded-md">
                        <h2 className="text-xl font-semibold mb-4 text-gray-800">Safety Reports</h2>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                <label htmlFor="incidents" className="block text-sm font-medium text-gray-700">Incidents</label>
                                <textarea
                                    id="incidents"
                            ...
                            <div>
                                <label htmlFor="nearMisses" className="block text-sm font-medium text-gray-700">Near Misses</label>
                                <textarea
                                    id="nearMisses"
                            ...
                            <div>
                                <label htmlFor="hazardsIdentified" className="block text-sm font-medium text-gray-700">Hazards Identified</label>
                                <textarea
                    ...
                    <div className="bg-gray-50 p-4 rounded-md">
                        <h2 className="text-xl font-semibold mb-4 text-gray-800">Work Progress</h2>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                <label htmlFor="completedTasks" className="block text-sm font-medium text-gray-700">Completed Tasks</label>
                                <textarea
                                    id="completedTasks"
                            ...
                            <div>
                                <label htmlFor="ongoingWork" className="block text-sm font-medium text-gray-700">Ongoing Work</label>
                                <textarea
                                    id="ongoingWork"
                            ...
                            <div>
                                <label htmlFor="upcomingWork" className="block text-sm font-medium text-gray-700">Upcoming Work</label>
                                <textarea
                                    id="upcomingWork"
                    ...
                    <div className="bg-gray-50 p-4 rounded-md">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                <label htmlFor="excavator" className="block text-sm font-medium text-gray-700">Excavator Status</label>
                                <input
                                    type="text"
                                    id="excavator"
                            ...
                            <div>
                                <label htmlFor="conveyor" className="block text-sm font-medium text-gray-700">Conveyor Status</label>
                                <input
                                    type="text"
                                    id="conveyor"
                            ...
                            <div>
                                <label htmlFor="crusher" className="block text-sm font-medium text-gray-700">Crusher Status</label>
                                <input
                                    type="text"
                                    id="crusher"
                    ...
                    <div className="bg-gray-50 p-4 rounded-md">
                        <h2 className="text-xl font-semibold mb-4 text-gray-800">Personnel Information</h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label htmlFor="shiftSupervisor" className="block text-sm font-medium text-gray-700">Shift Supervisor</label>
                                <input
                                    type="text"
                                    id="shiftSupervisor"
                            ...
                            <div>
                                <label htmlFor="keyPersonnelChanges" className="block text-sm font-medium text-gray-700">Key Personnel Changes</label>
                                <textarea
                    ...
                    <div>
                        <label htmlFor="notesForIncomingShift" className="block text-sm font-medium text-gray-700">Notes for Incoming Shift</label>
                        <textarea
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label htmlFor="signedBy" className="block text-sm font-medium text-gray-700">Signed By</label>
                            <input
                                type="text"
                                id="signedBy"
                                name="signedBy"
