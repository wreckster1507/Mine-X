        ...
        <div>
            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="space-y-6">
                    {shiftLogs.map((log) => (
                        <div key={log._id} className="bg-white shadow-md rounded-lg overflow-hidden">
                            <div
                            ...
                            >
                                <h2 className="text-xl font-semibold text-gray-800">
                                    Shift Log for {log.date} - Shift: {log.shift}
                                </h2>
                            ...
                            {expandedLogs[log._id] && (
                                <div className="p-4 space-y-4">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            <h3 className="font-semibold text-lg mb-2 text-gray-700">Production Data</h3>
                                            <p><span className="font-medium">Total Tonnage Mined:</span> {log.productionData.totalTonnageMined}</p>
                                            <p><span className="font-medium">Active Machines:</span> {log.productionData.activeMachines}</p>
                                            <p><span className="font-medium">Machine Downtime:</span> {log.productionData.machineDowntime}</p>
                                            <p><span className="font-medium">Additional Notes:</span> {log.productionData.additionalNotes}</p>
                                        </div>
                                        <div>
                                            <h3 className="font-semibold text-lg mb-2 text-gray-700">Safety Reports</h3>
                                            <p><span className="font-medium">Incidents:</span> {log.safetyReports.incidents}</p>
                                            <p><span className="font-medium">Near Misses:</span> {log.safetyReports.nearMisses}</p>
                                            <p><span className="font-medium">Hazards Identified:</span> {log.safetyReports.hazardsIdentified}</p>
                                        </div>
                                    </div>
                                    <div>
                                        <h3 className="font-semibold text-lg mb-2 text-gray-700">Work Progress</h3>
                                        <p><span className="font-medium">Completed Tasks:</span> {log.workProgress.completedTasks}</p>
                                        <p><span className="font-medium">Ongoing Work:</span> {log.workProgress.ongoingWork}</p>
                                        <p><span className="font-medium">Upcoming Work:</span> {log.workProgress.upcomingWork}</p>
                                    </div>
                                    <div>
                                        <h3 className="font-semibold text-lg mb-2 text-gray-700">Machine Status</h3>
                                        <p><span className="font-medium">Excavator:</span> {log.machineStatus.excavator}</p>
                                        <p><span className="font-medium">Conveyor:</span> {log.machineStatus.conveyor}</p>
                                        <p><span className="font-medium">Crusher:</span> {log.machineStatus.crusher}</p>
                                    </div>
                                    <div>
                                        <h3 className="font-semibold text-lg mb-2 text-gray-700">Personnel Information</h3>
                                        <p><span className="font-medium">Shift Supervisor:</span> {log.personnelInformation.shiftSupervisor}</p>
                                        <p><span className="font-medium">Key Personnel Changes:</span> {log.personnelInformation.keyPersonnelChanges}</p>
                                    </div>
                                    <div>
                                        <h3 className="font-semibold text-lg mb-2 text-gray-700">Additional Information</h3>
                                        <p><span className="font-medium">Notes for Incoming Shift:</span> {log.notesForIncomingShift}</p>
                                        <p><span className="font-medium">Signed By:</span> {log.signedBy}</p>
                                        <p><span className="font-medium">Time:</span> {log.time}</p>
                                    </div>
                                    {summaries[log._id] && (
                                        <div>
                                            <h3 className="font-semibold text-lg mb-2 text-gray-700">Summary</h3>
